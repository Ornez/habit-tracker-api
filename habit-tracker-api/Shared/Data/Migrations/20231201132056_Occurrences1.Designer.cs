...
namespace habit_tracker_api.Shared.Data.Migrations
{
    ...
    [Migration("20231201132056_Occurrences1")]
    partial class Occurrences1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("habit_tracker_api.Accounts.Entities.AppUserRole", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("habit_tracker_api.Accounts.Entities.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("habit_tracker_api.Accounts.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("habit_tracker_api.Accounts.Entities.AppUserRole", b =>
                {
                    b.HasOne("habit_tracker_api.Accounts.Entities.AppRole", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
